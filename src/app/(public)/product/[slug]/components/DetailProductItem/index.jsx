        ...
        <div className={classNames(styles.size)}>
          ...
          <div className={classNames(styles.listSize)}>
            <button
              ...
              className={classNames(styles.sizeSelecet, 'font-poppins', {
                [styles.sizeActive]: sizeSelected === 1,
              })}
            >
              XS
            </button>
            <button
              ...
              className={classNames(styles.sizeSelecet, 'font-poppins', {
                [styles.sizeActive]: sizeSelected === 2,
              })}
            >
              S
            </button>
            <button
              ...
              className={classNames(styles.sizeSelecet, 'font-poppins', {
                [styles.sizeActive]: sizeSelected === 3,
              })}
            >
              M
            </button>
            <button
              ...
              className={classNames(styles.sizeSelecet, 'font-poppins', {
                [styles.sizeActive]: sizeSelected === 4,
              })}
            >
              L
            </button>
            <button
              ...
              className={classNames(styles.sizeSelecet, 'font-poppins', {
                [styles.sizeActive]: sizeSelected === 5,
              })}
            >
              XL
            </button>

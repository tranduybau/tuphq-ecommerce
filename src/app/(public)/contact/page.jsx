            ...
            <div className={classNames(styles.contact)}>
                <div className={classNames(styles.sidebar, 'font-poppins')}>
                    <div className={classNames(styles.phoneBlock)}>
                        ...
                        <span className={classNames(styles.text, 'mt-[24px]')}>We are available 24/7, 7 days a week.</span>
                        <span className={classNames(styles.text)}>Phone: +8801611112222</span>
                    </div>
                    <div className={classNames(styles.emailBlock)}>
                        <div className={classNames(styles.heading)}>
                            <EmailIcon className={classNames(styles.icon)} />
                            <span className={classNames(styles.headingText)}>Write To US</span>
                        </div>
                        <span className={classNames(styles.text, 'mt-[24px]')}>Fill out our form and we will contact you within 24 hours.</span>
                        <span className={classNames(styles.text)}>Emails: customer@exclusive.com</span>
                        <span className={classNames(styles.text)}>Emails: support@exclusive.com</span>
                    </div>
                </div>

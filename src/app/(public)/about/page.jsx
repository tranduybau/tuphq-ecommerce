        ...
        <section className={classNames(styles.wrapper)}>
            ...
            <div className={classNames(styles.story)}>
                <div className={classNames(styles.paragraph)}>
                    <span className={classNames(styles.heading, 'font-inter')}>Our Story</span>
                    <span className={classNames(styles.text, 'font-poppins')}>
                        Launced in 2015, Exclusive is South Asia’s premier online shopping makterplace with an active presense in Bangladesh. Supported by wide range of tailored marketing, data and service solutions, Exclusive has 10,500 sallers and 300 brands and serves 3 millioons customers across the region.
                    </span>
                    <span className={classNames(styles.text, 'font-poppins', 'mt-[24px]')}>
            ...
            <div className={classNames(styles.detail, 'gap-[30px]', 'container', 'px-0')}>
                <DetailItem
                    icon={ShopIcon}
                    count='10.5k '

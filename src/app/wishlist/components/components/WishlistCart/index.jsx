...
import styles from './WishlistCart.module.scss'
import classNames from 'classnames'

//icon
import DeleteIcon from '@/svgs/icon-delete.svg'
import QuickViewIcon from '@/svgs/Quick-View.svg'
import CartIcon from '@/svgs/Cart1.svg'
        ...
        <div className={`${styles.wrapper}`}>
            <div className={`${styles.imageWrapper}`}>
                ...
                <div className={`${styles.discountAndActions}`}>
                    ...
                    {props.type && <div className={`${styles.cartIconWrapper}`}>
                ...
                <div className={`${styles.addCart}`}>
                    ...
                    <span className={`${styles.addCartText} font-poppins`}>Add To Cart</span>
                </div>
            </div>
